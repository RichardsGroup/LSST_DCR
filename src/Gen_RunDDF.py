...
#             for mag in mags:
            ...
            for ddf in ddfFields:                
                ...
                m5Median = metrics.MedianMetric('fiveSigmaDepth', 
                                                metricName = f'm5Meidan_{band}_{ddf}')
                m5Median_mb = metricBundles.MetricBundle(m5Median, slicer, ddf_constraint)
                
                m5RMS = metrics.RmsMetric('fiveSigmaDepth', 
                                          metricName = f'm5RMS_{band}_{ddf}')
#                 m5RMS.name = m5RMS.metricName + f'_{ddf}'
                m5RMS_mb = metricBundles.MetricBundle(m5RMS, slicer, ddf_constraint)
                
                airmassMax = metrics.MaxMetric('airmass', 
                                               metricName = f'airmassMax_{band}_{ddf}')
#                 airmassMax.name = airmassMax.metricName + f'_{ddf}'
